...
Source: The Gazette of India Extraordinary (Official PDF)
"""

chapter_data = {
    "chapter_no": "CHAPTER I",
    "chapter_title": "PRELIMINARY",
    "section_range": "Section 1 to Section 5",
    "total_sections": 5,
    "sections": [
        {
...
def render_display():
    ...
    sub_sep = "-" * 80
    print(sep)
    print(f" {chapter_data['chapter_no']}: {chapter_data['chapter_title']}")
    print(f" {chapter_data['section_range']} | Total Sections: {chapter_data['total_sections']}")
    print(sep)
    for sec in chapter_data["sections"]:
        print(f"\n>>> [{sec['section_no']}] {sec['title']}")
        print(sub_sep)
        print(sec["bare_text"].strip())
        print(sub_sep)
